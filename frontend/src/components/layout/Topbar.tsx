...
export function Topbar({ onToggleSidebar }: TopbarProps) {
  ...
  return (
    <header className="h-16 bg-white/95 backdrop-blur border-b border-primary-100 flex items-center justify-between px-6 flex-shrink-0 shadow-sm">
      {/* Left side */}
      <div className="flex items-center gap-4">
        <button
          onClick={onToggleSidebar}
          className="p-2 rounded-lg text-primary-700 hover:bg-primary-50 transition-colors lg:hidden"
        >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          ...
          >
            ...
            <ChevronDown className="w-4 h-4 text-primary-300 hidden md:block" />
          </button>
          ...
          {showDropdown && (
            <>
              ...
              />
              <div className="absolute right-0 top-full mt-2 w-52 bg-white rounded-xl shadow-lg border border-primary-100 py-2 z-20">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-primary-900 hover:bg-primary-50 transition-colors"
                >
